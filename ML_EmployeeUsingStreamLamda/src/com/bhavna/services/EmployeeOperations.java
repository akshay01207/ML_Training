...
public class EmployeeOperations {
	...
	public void addEmployee() {
		...
		// Creating Address
		employeeList.add(new Employee("akshay", 50000, "Greater Noida"));
		employeeList.add(new Employee("arpit", 40000, "Gzb"));
		employeeList.add(new Employee("ekjot", 45000, "Delhi"));
		employeeList.add(new Employee("Saumya", 50000, "Bihar"));
		employeeList.add(new Employee("sarthak", 55000, "Greater Noida"));
		employeeList.add(new Employee("Vishal", 65000, "Hyderabad"));
		employeeList.add(new Employee("vanisha", 47000, "New Delhi"));
		employeeList.add(new Employee("Rashi", 30000, "Hyderabad"));
